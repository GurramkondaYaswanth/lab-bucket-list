...
public class MapServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String,TouristPlace> bucketlistHM = new HashMap<String, TouristPlace>();
		...
		if(add!=null) {
			...
			request.setAttribute("bucketList", mo.add(tp));
		...
		if(remove!=null) {
			...
			request.setAttribute("bucketList", mo.remove(tp));
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/map.jsp");
			rd.forward(request, response);
		}
		...
		if(sortRandom!=null) {
			...
			request.setAttribute("bucketList",mo.sortRandomly(tp));
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/map.jsp");
			rd.forward(request, response);
		}
		...
		if(sortInEntryOrder!=null) {
			...
			request.setAttribute("bucketList", mo.sortInEntryOrder(tp));
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/map.jsp");
			rd.forward(request, response);
		}
		if(sortAlphabetically!=null) {
			...
			request.setAttribute("bucketList",mo.sortAlphabetically(tp));
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/map.jsp");
			rd.forward(request, response);
		}
		...
		if(reset!=null) {	
			...
			Object map = mo.reset(bucketlistHM);
